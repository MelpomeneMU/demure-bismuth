...
@desc here=%R%TIf you're here, we assume you want to create a crew. If you just want to join one, log on to the LFG (Looking For Group) channel - %chlfg/on%cn - and ask around, or check out the Doskvol Rumors board - %ch+bbread Doskvol Rumors%cn, to see who's recruiting. Now, on to the crew creation process!%R%R%TCrew creation is a bit more involved than regular Scoundrel creation because it's designed to be done by multiple people.%R%R%TStep 1 is to come up with a name and %ch+crew/create <name>%cn. Don't worry, you can change it later.%R%R%TStep 2 is to invite your crew mates to help you out with this process - %ch+crew/invite <name>%cn. (If you're doing a solo crew, that's fine! See %ch+note here/Solo%cn.)%R%R%TStep 3 is optional: consider starting a channel for your crew with %ch+channel/create <crew name>=<description>%cn, then %ch+crew/channel <channel>%cn so you can all join that channel and talk this stuff over and make decisions as a group. Everyone will be able to see the crew's stats as they're set up.%R%R%TWhen you're ready, proceed to the Next room to get started on mechanical stuff.%R%R%TAll chat in this room goes to the Chargen channel.%R
