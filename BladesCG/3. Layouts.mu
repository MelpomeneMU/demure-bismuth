...
&layout.crew1 [v(d.cgf)]=strcat(setq(C, ulocal(f.get-player-stat, %0, crew object)), ulocal(layout.crew_name, %qC, %1), %r, if(cor(cand(member(%qC, %1), member(%0, %1)), not(t(%qC)), isapproved(%1), isstaff(%1)), strcat(ulocal(layout.crew_bio, %qC, %1), %r, ulocal(layout.crew_pools, %qC, %1), %r, ulocal(layout.crew-abilities, %qC, %1), %r, ulocal(layout.crew-upgrades, %qC, %1), %r, ulocal(layout.crew-xp_triggers, %qC, %1)), strcat(formattext(Full crew sheet will become available once you are approved., 1, %1))))

&layout.crew2 [v(d.cgf)]=strcat(setq(C, ulocal(f.get-player-stat, %0, crew object)), ulocal(layout.crew_name, %qC, %1), %r, if(cor(cand(member(%qC, %1), member(%0, %1)), not(t(%qC)), isapproved(%1), isstaff(%1)), strcat(ulocal(layout.crew_bio, %qC, %1), %r, ulocal(layout.crew-map, %qC, %1), %r, ulocal(layout.crew-cohorts, %qC, %1), %r, ulocal(layout.crew-contacts, %qC, %1), %r, ulocal(layout.crew-factions, %qC, %1), %r, ulocal(layout.crew-members, %qC, %1)), strcat(formattext(Full crew sheet will become available once you are approved., 1, %1))))
...
&layout.factions [v(d.cgf)]=strcat(header(All Factions, %1), %r, setq(F, ulocal(f.get-player-stat, %0, Factions)), setq(H, ulocal(f.get-player-stat, %0, hunting grounds)), setq(W, div(getremainingwidth(%1), 2)), edit(multicol(fliplist(iter(xget(%vD, d.factions), strcat(divider(title(edit(itext(0), d.factions.,, _, %b)), %qW), |, iter(xget(%vD, itext(0)), cat(_, ulocal(f.get-faction-status, %0, itext(0)), strcat(itext(0), if(t(member(xget(%vD, ulocal(f.get-stat-location, d.%qH.factions)), itext(0), |)), %ch%cy *%cn))), |, |)),, |), 2, |), * *, 0, |), _, %b), %r, footer(%ch%cy*%cn indicates factions that claim this crew's hunting grounds, %1))
...
&layout.crew-map.smugglers [v(d.cgf)]=strcat(strcat(space(45), ulocal(f.mark-map, %0, A1, 1), A1: Turf%r%b______, space(3), ______, space(3), ______, space(3), ______, space(3), ______, space(2), ulocal(f.mark-map, %0, A2, 1), A2: Side Business, %r, |, space(5), ulocal(f.mark-map, %0, A1), | |, space(5), ulocal(f.mark-map, %0, A2), | |, space(5), ulocal(f.mark-map, %0, A3), | |, space(5), ulocal(f.mark-map, %0, A4), | |, space(5), ulocal(f.mark-map, %0, A5), |, %b, ulocal(f.mark-map, %0, A3, 1), A3: Luxury Fence, %r, |, space(2), A1, space(2), |-|, space(2), A2, space(2), | |, space(2), A3, space(2), | |, space(2), A4, space(2), |-|, space(2), A5, space(2), |, %b, ulocal(f.mark-map, %0, A4, 1), A4: Vice Den, %r, |______| |______| |______| |______| |______|, %b, ulocal(f.mark-map, %0, A5, 1), A5: Tavern), %r, strcat(%b__|___, space(3), ___|__, space(3), ___|__, space(3), ___|__, space(3), ______, space(2), ulocal(f.mark-map, %0, B1, 1), B1: Ancient Gate, %r, |, space(5), ulocal(f.mark-map, %0, B1), | |, space(5), ulocal(f.mark-map, %0, B2), | |, space(5), X| |, space(5), ulocal(f.mark-map, %0, B4), | |, space(5), ulocal(f.mark-map, %0, B5), |, %b, ulocal(f.mark-map, %0, B2, 1), B2: Turf, %r, |, space(2), B1, space(2), | |, space(2), B2, space(2), |-| LAIR |-|, space(2), B4, space(2), |-|, space(2), B5, space(2), |, %b, ulocal(f.mark-map, %0, B4, 1), B4: Turf, %r, |______| |______| |______| |______| |______|, %b, ulocal(f.mark-map, %0, B5, 1), B5: Turf), %r, strcat(%b__|___, space(3), ___|__, space(3), ___|__, space(3), ___|__, space(3), ______, space(2), ulocal(f.mark-map, %0, C1, 1), C1: Secret Routes, %r, |, space(5), ulocal(f.mark-map, %0, C1), | |, space(5), ulocal(f.mark-map, %0, C2), | |, space(5), ulocal(f.mark-map, %0, C3), | |, space(5), ulocal(f.mark-map, %0, C4), | |, space(5), ulocal(f.mark-map, %0, C5), |, %b, ulocal(f.mark-map, %0, C2, 1), C2: Informants, %r, |, space(2), C1, space(2), |-|, space(2), C2, space(2), | |, space(2), C3, space(2), | |, space(2), C4, space(2), |-|, space(2), C5, space(2), |, %b, ulocal(f.mark-map, %0, C3, 1), C3: Fleet, %r, |______| |______| |______| |______| |______|, %b, ulocal(f.mark-map, %0, C4, 1), C4: Cover Operation, %r, space(45), ulocal(f.mark-map, %0, C5, 1), C5: Warehouse, %r))
...
&layout.cg-commands [v(d.cgf)]=strcat(divider(Commands), %r, multicol(+stat/set <stat>=<value>|+stat/set <stat>= to clear a stat|+stat/clear to start over|%0, * *, 0, |, %1))
