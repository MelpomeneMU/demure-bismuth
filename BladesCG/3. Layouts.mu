...
&layout.list [v(d.cgf)]=itemize(setunion(%0, %0, |), |, if(t(%1), %1, and))
...
@@ TODO: future +rep/log:
@@ formattext(strcat(*, %b, if(t(setr(F, ulocal(f.get-player-stat, %0, faction.hunting))), first(%qF, |) claim[if(not(strmatch(first(%qF, |), *s \(*\))), s)] this crew's hunting ground. The crew paid [rest(%qF, |)] coin to keep them happy., This crew hasn't yet chosen a hunting ground faction.), %r, *, %b, if(t(setr(F, ulocal(f.get-player-stat, %0, faction.helped))), first(%qF, |) helped this crew gain an Upgrade. The crew paid [rest(%qF, |)] coin to thank them., This crew hasn't yet chosen a faction that helped them get an Upgrade.), %r, *, %b, if(t(setr(F, ulocal(f.get-player-stat, %0, faction.harmed))), first(%qF, |) were harmed when this crew got an Upgrade. The crew paid [rest(%qF, |)] coin to pacify them., This crew hasn't yet chosen a faction that was harmed by them getting an Upgrade.), %r, *, %b, if(t(setr(F, ulocal(f.get-player-stat, %0, faction.friendly))), first(%qF, |) are friendly to the crew's Favorite Contact., This crew hasn't chosen a faction that is friendly to their Favorite Contact yet.), %r, *, %b, if(t(setr(F, ulocal(f.get-player-stat, %0, faction.unfriendly))), first(%qF, |) are unfriendly to the crew's Favorite Contact., This crew hasn't chosen a faction that is unfriendly to their Favorite Contact yet.)), 0, %1)
...
&layout.crew-map.smugglers [v(d.cgf)]=strcat(strcat(space(45), ulocal(f.mark-map, %0, A1, 1), A1: Turf%r%b______, space(3), ______, space(3), ______, space(3), ______, space(3), ______, space(2), ulocal(f.mark-map, %0, A2, 1), A2: Side Business, %r, |, ulocal(layout.map-a-line, %0), A3: Luxury Fence, %r, |, space(2), A1, space(2), |-|, space(2), A2, space(2), | |, space(2), A3, space(2), | |, space(2), A4, space(2), |-|, space(2), A5, space(2), |, %b, ulocal(f.mark-map, %0, A4, 1), A4: Vice Den, %r, |______| |______| |______| |______| |______|, %b, ulocal(f.mark-map, %0, A5, 1), A5: Tavern), %r, strcat(%b__|___, space(3), ___|__, space(3), ___|__, space(3), ___|__, space(3), ______, space(2), ulocal(f.mark-map, %0, B1, 1), B1: Ancient Gate, %r, |, ulocal(layout.map-b-line, %0), B2: Turf, %r, |, space(2), B1, space(2), | |, space(2), B2, space(2), |-| LAIR |-|, space(2), B4, space(2), |-|, space(2), B5, space(2), |, %b, ulocal(f.mark-map, %0, B4, 1), B4: Turf, %r, |______| |______| |______| |______| |______|, %b, ulocal(f.mark-map, %0, B5, 1), B5: Turf), %r, strcat(%b__|___, space(3), ___|__, space(3), ___|__, space(3), ___|__, space(3), ______, space(2), ulocal(f.mark-map, %0, C1, 1), C1: Secret Routes, %r, |, ulocal(layout.map-c-line, %0), C2: Informants, %r, |, space(2), C1, space(2), |-|, space(2), C2, space(2), | |, space(2), C3, space(2), | |, space(2), C4, space(2), |-|, space(2), C5, space(2), |, %b, ulocal(f.mark-map, %0, C3, 1), C3: Fleet, %r, |______| |______| |______| |______| |______|, %b, ulocal(f.mark-map, %0, C4, 1), C4: Cover Operation, %r, space(45), ulocal(f.mark-map, %0, C5, 1), C5: Warehouse, %r))

&layout.crew-map.shadows [v(d.cgf)]=strcat(strcat(space(45), ulocal(f.mark-map, %0, A1, 1), A1: Interro. Chamber, %r, %b______, space(3), ______, space(3), ______, space(3), ______, space(3), ______, space(2), ulocal(f.mark-map, %0, A2, 1), A2: Turf, %r, |, ulocal(layout.map-a-line, %0), A3: Loyal Fence, %r, |, space(2), A1, space(2), |-|, space(2), A2, space(2), |-|, space(2), A3, space(2), | |, space(2), A4, space(2), |-|, space(2), A5, space(2), |, %b, ulocal(f.mark-map, %0, A4, 1), A4: Gambling Den, %r, |______| |______| |______| |______| |______|, %b, ulocal(f.mark-map, %0, A5, 1), A5: Tavern), %r, strcat(%b__|___, space(3), ______, space(3), ___|__, space(3), ___|__, space(3), ___|__, space(2), ulocal(f.mark-map, %0, B1, 1), B1: Drug Den, %r, |, ulocal(layout.map-b-line, %0), B2: Informants, %r, |, space(2), B1, space(2), |-|, space(2), B2, space(2), |-| LAIR |-|, space(2), B4, space(2), |-|, space(2), B5, space(2), |, %b, ulocal(f.mark-map, %0, B4, 1), B4: Turf, %r, |______| |______| |______| |______| |______|, %b, ulocal(f.mark-map, %0, B5, 1), B5: Lookouts), %r, strcat(%b__|___, space(3), ___|__, space(3), ___|__, space(3), ______, space(3), ___|__, space(2), ulocal(f.mark-map, %0, C1, 1), C1: Hagfish Farm, %r, |, ulocal(layout.map-c-line, %0), C2: Infirmary, %r, |, space(2), C1, space(2), |-|, space(2), C2, space(2), | |, space(2), C3, space(2), |-|, space(2), C4, space(2), |-|, space(2), C5, space(2), |, %b, ulocal(f.mark-map, %0, C3, 1), C3: Covert Drops, %r, |______| |______| |______| |______| |______|, %b, ulocal(f.mark-map, %0, C4, 1), C4: Turf, %r, space(45), ulocal(f.mark-map, %0, C5, 1), C5: Secret Pathways, %r))

&layout.crew-map.hawkers [v(d.cgf)]=strcat(strcat(space(45), ulocal(f.mark-map, %0, A1, 1), A1: Turf, %r, %b______, space(3), ______, space(3), ______, space(3), ______, space(3), ______, space(2), ulocal(f.mark-map, %0, A2, 1), A2: Personal Clothier, %r, |, ulocal(layout.map-a-line, %0), A3: Local Graft, %r, |, space(2), A1, space(2), |-|, space(2), A2, space(2), |-|, space(2), A3, space(2), | |, space(2), A4, space(2), |-|, space(2), A5, space(2), |, %b, ulocal(f.mark-map, %0, A4, 1), A4: Lookouts, %r, |______| |______| |______| |______| |______|, %b, ulocal(f.mark-map, %0, A5, 1), A5: Informants), %r, strcat(%b__|___, space(3), ___|__, space(3), ___|__, space(3), ___|__, space(3), ___|__, space(2), ulocal(f.mark-map, %0, B1, 1), B1: Turf, %r, |, ulocal(layout.map-b-line, %0), B2: Turf, %r, |, space(2), B1, space(2), | |, space(2), B2, space(2), |-| LAIR |-|, space(2), B4, space(2), |-|, space(2), B5, space(2), |, %b, ulocal(f.mark-map, %0, B4, 1), B4: Turf, %r, |______| |______| |______| |______| |______|, %b, ulocal(f.mark-map, %0, B5, 1), B5: Luxury Venue), %r, strcat(%b__|___, space(3), ___|__, space(3), ___|__, space(3), ___|__, space(3), ______, space(2), ulocal(f.mark-map, %0, C1, 1), C1: Foreign Market, %r, |, ulocal(layout.map-c-line, %0), C2: Vice Den, %r, |, space(2), C1, space(2), |-|, space(2), C2, space(2), | |, space(2), C3, space(2), |-|, space(2), C4, space(2), |-|, space(2), C5, space(2), |, %b, ulocal(f.mark-map, %0, C3, 1), C3: Surplus Caches, %r, |______| |______| |______| |______| |______|, %b, ulocal(f.mark-map, %0, C4, 1), C4: Cover Operation, %r, , space(45), ulocal(f.mark-map, %0, C5, 1), C5: Cover Identities, %r))

&layout.crew-map.cult [v(d.cgf)]=strcat(strcat(space(45), ulocal(f.mark-map, %0, A1, 1), A1: Cloister, %r, %b______, space(3), ______, space(3), ______, space(3), ______, space(3), ______, space(2), ulocal(f.mark-map, %0, A2, 1), A2: Vice Den, %r, |, ulocal(layout.map-a-line, %0), A3: Offeratory, %r, |, space(2), A1, space(2), |-|, space(2), A2, space(2), |-|, space(2), A3, space(2), | |, space(2), A4, space(2), |-|, space(2), A5, space(2), |, %b, ulocal(f.mark-map, %0, A4, 1), A4: Ancient Obelisk, %r, |______| |______| |______| |______| |______|, %b, ulocal(f.mark-map, %0, A5, 1), A5: Ancient Tower), %r, strcat(%b__|___, space(3), ___|__, space(3), ___|__, space(3), ______, space(3), ___|__, space(2), ulocal(f.mark-map, %0, B1, 1), B1: Turf, %r, |, ulocal(layout.map-b-line, %0), B2: Turf, %r, |, space(2), B1, space(2), |-|, space(2), B2, space(2), |-| LAIR |-|, space(2), B4, space(2), |-|, space(2), B5, space(2), |, %b, ulocal(f.mark-map, %0, B4, 1), B4: Turf, %r, |______| |______| |______| |______| |______|, %b, ulocal(f.mark-map, %0, B5, 1), B5: Turf), %r, strcat(%b______, space(3), ___|__, space(3), ___|__, space(3), ___|__, space(3), ___|__, space(2), ulocal(f.mark-map, %0, C1, 1), C1: Spirit Well, %r, |, ulocal(layout.map-c-line, %0), C2: Ancient Gate, %r, |, space(2), C1, space(2), |-|, space(2), C2, space(2), | |, space(2), C3, space(2), | |, space(2), C4, space(2), |-|, space(2), C5, space(2), |, %b, ulocal(f.mark-map, %0, C3, 1), C3: Sanctuary, %r, |______| |______| |______| |______| |______|, %b, ulocal(f.mark-map, %0, C4, 1), C4: Sacred Nexus, %r, , space(45), ulocal(f.mark-map, %0, C5, 1), C5: Ancient Altar, %r))

&layout.crew-map.assassins [v(d.cgf)]=strcat(strcat(space(45), ulocal(f.mark-map, %0, A1, 1), A1: Training Rooms, %r, %b______, space(3), ______, space(3), ______, space(3), ______, space(3), ______, space(2), ulocal(f.mark-map, %0, A2, 1), A2: Vice Den, %r, |, ulocal(layout.map-a-line, %0), A3: Fixer, %r, |, space(2), A1, space(2), |-|, space(2), A2, space(2), | |, space(2), A3, space(2), | |, space(2), A4, space(2), |-|, space(2), A5, space(2), |, %b, ulocal(f.mark-map, %0, A4, 1), A4: Informants, %r, |______| |______| |______| |______| |______|, %b, ulocal(f.mark-map, %0, A5, 1), A5: Hagfish Farm), %r, strcat(%b__|___, space(3), ___|__, space(3), ___|__, space(3), ___|__, space(3), ___|__, space(2), ulocal(f.mark-map, %0, B1, 1), B1: Victim Trophies, %r, |, ulocal(layout.map-b-line, %0), B2: Turf, %r, |, space(2), B1, space(2), | |, space(2), B2, space(2), |-| LAIR |-|, space(2), B4, space(2), |-|, space(2), B5, space(2), |, %b, ulocal(f.mark-map, %0, B4, 1), B4: Turf, %r, |______| |______| |______| |______| |______|, %b, ulocal(f.mark-map, %0, B5, 1), B5: Cover Operation), %r, strcat(%b__|___, space(3), ___|__, space(3), ___|__, space(3), ______, space(3), ___|__, space(2), ulocal(f.mark-map, %0, C1, 1), C1: Protection Racket, %r, |, ulocal(layout.map-c-line, %0), C2: Infirmary, %r, |, space(2), C1, space(2), |-|, space(2), C2, space(2), | |, space(2), C3, space(2), | |, space(2), C4, space(2), |-|, space(2), C5, space(2), |, %b, ulocal(f.mark-map, %0, C3, 1), C3: Envoy, %r, |______| |______| |______| |______| |______|, %b, ulocal(f.mark-map, %0, C4, 1), C4: Cover Identities, %r, , space(45), ulocal(f.mark-map, %0, C5, 1), C5: City Records, %r))

&layout.crew-map.bravos [v(d.cgf)]=strcat(strcat(space(45), ulocal(f.mark-map, %0, A1, 1), A1: Barracks, %r, %b______, space(3), ______, space(3), ______, space(3), ______, space(3), ______, space(2), ulocal(f.mark-map, %0, A2, 1), A2: Turf, %r, |, ulocal(layout.map-a-line, %0), A3: Terrorized Citizens, %r, |, space(2), A1, space(2), |-|, space(2), A2, space(2), |-|, space(2), A3, space(2), | |, space(2), A4, space(2), |-|, space(2), A5, space(2), |, %b, ulocal(f.mark-map, %0, A4, 1), A4: Informants, %r, |______| |______| |______| |______| |______|, %b, ulocal(f.mark-map, %0, A5, 1), A5: Protection Racket), %r, strcat(%b__|___, space(3), ______, space(3), ___|__, space(3), ___|__, space(3), ___|__, space(2), ulocal(f.mark-map, %0, B1, 1), B1: Fighting Pits, %r, |, ulocal(layout.map-b-line, %0), B2: Turf, %r, |, space(2), B1, space(2), |-|, space(2), B2, space(2), |-| LAIR |-|, space(2), B4, space(2), |-|, space(2), B5, space(2), |, %b, ulocal(f.mark-map, %0, B4, 1), B4: Turf, %r, |______| |______| |______| |______| |______|, %b, ulocal(f.mark-map, %0, B5, 1), B5: Turf), %r, strcat(%b__|___, space(3), ___|__, space(3), ___|__, space(3), ___|__, space(3), ___|__, space(2), ulocal(f.mark-map, %0, C1, 1), C1: Infirmary, %r, |, ulocal(layout.map-c-line, %0), C2: Blue. Intimidation, %r, |, space(2), C1, space(2), |-|, space(2), C2, space(2), | |, space(2), C3, space(2), |-|, space(2), C4, space(2), |-|, space(2), C5, space(2), |, %b, ulocal(f.mark-map, %0, C3, 1), C3: Street Fence, %r, |______| |______| |______| |______| |______|, %b, ulocal(f.mark-map, %0, C4, 1), C4: Warehouses, %r, , space(45), ulocal(f.mark-map, %0, C5, 1), C5: Blue. Confederates, %r))
...
&layout.crew-cg-errors [v(d.cgf)]=strcat(header(Crew creation instructions, %1), %r, formattext(strcat(setq(C, ulocal(f.get-player-stat, %0, crew object)), ulocal(layout.test, t(%qC), You have joined or created a crew., +crew/join <name> or +crew/create <name> to set your crew up.), %r, ulocal(layout.test, ulocal(check.crew.bio, %qC), Set all your crew's bio fields.), %r, ulocal(layout.test, ulocal(check.crew.abilities, %qC), Select one Crew Ability.), %r, ulocal(layout.test, ulocal(check.crew.contacts, %qC), Set your Contacts and Favorite.), %r, ulocal(layout.test, ulocal(check.crew.upgrades, %qC), Select 4 points of Upgrades.), ulocal(layout.test-line, ulocal(check.cohort-edges-count, %qC), Pick 1-2 Edges and Flaws for your Cohorts.), ulocal(layout.test-line, ulocal(check.cohort-flaws-balance, %qC), Cohort Edges and Flaws should balance one for one: one Edge = one Flaw.), ulocal(layout.test-line, ulocal(check.like-part-of-the-family-cohort, %qC), You have Like Part of the Family. Take the Vehicle Upgrade and create a Cohort with the Vehicle Type.), ulocal(layout.test-line, ulocal(check.vehicle-without-crew-ability, %qC), Having a Vehicle Cohort without the Crew Ability "Like Part of the Family" is not allowed.), %r, ulocal(layout.test, ulocal(check.faction_questions_answered, %qC), Answer 5 faction questions.), ulocal(layout.test-line, ulocal(check.faction_status_limits, %qC), You're at less than -3 or greater than +3 to a faction. Shift your factions around.), %r, ulocal(layout.test, ulocal(check.crew.xp_triggers, %qC), Select a Crew XP Trigger.)), 0, %1), ulocal(layout.cg-commands, +crew/all to see everything|+cohort/create <name>=<type>|+faction/set <question>=<faction>|+cohort/set <stat>=<value>|+faction/pay <question>=<amount>|+crew/lock to submit to staff|+faction/boost or unboost, %1), %r, footer(cg/on to join the Chargen channel and ask questions!, %1))

&layout.full-cg-errors [v(d.cgf)]=strcat(formattext(strcat(ulocal(layout.test, ulocal(check.scoundrel.bio, %0), You have all your bio fields set., Some of your bio fields %(not counting Crew%) are not set.), ulocal(layout.test-line, ulocal(check.simple.desc, %0), @desc me=<Character's normal description>), %r, ulocal(layout.test, ulocal(check.scoundrel.actions, %0), 7 action dots chosen., You need 7 action dots. You have [ulocal(f.get-total-player-actions, %0)].), %r, ulocal(layout.test, ulocal(check.scoundrel.abilities, %0), One ability selected., You need one ability. You have [ulocal(f.get-total-player-abilities, %0)].), %r, ulocal(layout.test, ulocal(check.scoundrel.friends, %0), You have friends%, an ally%, and a rival., You need friends%, an ally%, and a rival.), %r, ulocal(layout.test, ulocal(check.scoundrel.gear, %0), You have chosen your gear., You need gear!), %r, ulocal(layout.test, ulocal(check.scoundrel.xp_triggers, %0), You have chosen your XP triggers., You need to select your XP triggers.)), 0, %1), ulocal(layout.cg-commands, +sheet/all to see everything|+stats/lock to submit to staff, %1))
...
&layout.xp [v(d.cgf)]=strcat(header(XP and Advancements, %1), %r, multicol(strcat(|, ansi(first(themecolors())u, Total), |, ansi(first(themecolors())u, Current/Max), |, ansi(first(themecolors())u, Advancements Spent/Total), |, ansi(first(themecolors()), Insight), |, ulocal(f.get-xp, %0, insight, total), |, ulocal(f.get-xp, %0, insight, current), /, ulocal(f.get-xp, %0, insight, max), |, ulocal(f.get-advancements, %0, insight, spent), /, ulocal(f.get-advancements, %0, insight, total), |, ansi(first(themecolors()), Prowess), |, ulocal(f.get-xp, %0, Prowess, total), |, ulocal(f.get-xp, %0, Prowess, current), /, ulocal(f.get-xp, %0, Prowess, max), |, ulocal(f.get-advancements, %0, Prowess, spent), /, ulocal(f.get-advancements, %0, Prowess, total), |, ansi(first(themecolors()), Resolve), |, ulocal(f.get-xp, %0, Resolve, total), |, ulocal(f.get-xp, %0, Resolve, current), /, ulocal(f.get-xp, %0, Resolve, max), |, ulocal(f.get-advancements, %0, Resolve, spent), /, ulocal(f.get-advancements, %0, Resolve, total), |, ansi(first(themecolors()), Playbook), |, ulocal(f.get-xp, %0, Playbook, total), |, ulocal(f.get-xp, %0, Playbook, current), /, ulocal(f.get-xp, %0, Playbook, max), |, ulocal(f.get-advancements, %0, Playbook, spent), /, ulocal(f.get-advancements, %0, Playbook, total), |, ansi(first(themecolors()), Crew), |, ulocal(f.get-xp, %0, Crew, total), |, ulocal(f.get-xp, %0, Crew, current), /, ulocal(f.get-xp, %0, Crew, max), |, ulocal(f.get-advancements, %0, Crew, spent), /, ulocal(f.get-advancements, %0, Crew, total), |, ansi(first(themecolors()), Untracked), |, ulocal(f.get-xp, %0, Untracked, total)), 15 10 15 *, 0, |, %1), %r, footer(, %1))
