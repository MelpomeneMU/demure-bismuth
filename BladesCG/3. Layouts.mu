...
&layout.crew-map [v(d.cgf)]=strcat(divider(Holdings, %1), %r, ulocal(layout.crew-map-format, %0, %1, ulocal(f.get-player-stat-or-default, %0, crew type, blank)), if(t(setr(U, ulocal(f.get-player-stat, %0, Claims))), strcat(%r, divider(Unmapped Claims, %1), %r, multicol(%qU, * *, 0, |, %1))))
